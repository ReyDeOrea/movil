...
const getEntradas = new GetEntradasUseCase(entradaRepository);
const deleteEntrada = new DeleteEntradaUseCase(entradaRepository);
...
export default function EntradasView() {
    ...
    const eliminarEntrada = (idEntrada: string) => {
        Alert.alert(
            "Eliminar entrada",
            ...
            [
                ...
                },
                {
                    ...
                    onPress: async () => {
                        try {
                            await deleteEntrada.execute(idEntrada);
                            ...
                            Alert.alert(
                                "Error",
                                error.message || "No se pudo eliminar la entrada"
                            );
                        }
                    },
                },
    ...
    const entradasFiltradas = entradas.filter((entrada) => {
        ...
        const material = normalizeText(entrada.nombreMaterial ?? "");
        const tecnico = normalizeText(entrada.nombreTecnicoExterno ?? "");
        const observacion = normalizeText(entrada.observaciones ?? "");
        const codigo = String(entrada.numMaterial ?? "");
    ...
    return (
        <>
            ...
            <View style={styles.container}>
                ...
                <Text style={styles.title}>Entradas de material</Text>
